...
if __name__ == "__main__":
  ...
  scheduler = torch.optim.lr_scheduler.MultiStepLR(
      optimizer, milestones=[8, 13], gamma=0.1)
  num_epochs = 50
  ...
  for epoch in range(start_epoch, num_epochs):
    ...
    for iter, batch in enumerate_tqdm:
      ...
      labels, regressor_target = box_head.create_ground_truth(
      ...
      loss, loss_class, loss_reg = box_head.compute_loss(
          class_logits,
          box_preds,
    ...
    print("Epoch: {}, loss={}, class loss={}, regression loss={}".format(
        epoch, avg_train_loss, avg_class_train_loss, avg_regression_train_loss))
